...
/*AIADDED by mdpar*/
	AIself_handle((int)x, (int)y, (int)((90.0/32.0) * (float)heading), (int)vx, (int)vy);
	AIship_pointer_refresh();
	AImap_ship_refresh();
...
/*AIADDED by mdpar*/
	AIship_handle((int)id, (int)x, (int)y, (int)((90.0/32.0) * (float)dir), shield);
