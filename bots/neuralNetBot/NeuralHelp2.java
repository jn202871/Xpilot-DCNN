...
class NeuralHelp2 extends javaAI {
        ...
        public NeuralHelp2(String args[]) {
                super(args);
        }
        ...
        public static void main(String args[]) {
            ...
            try {
                FileInputStream file = new FileInputStream("net2.ser");
                ...
                NeuralHelp2 help = new NeuralHelp2(new_args);
        }
