...
def train_cifar(config):
    ...
    optimizer = optim.AdamW(net.parameters(), lr=config["lr"], weight_decay=config["wd"])
...
class Net(nn.Module):
    def __init__(self, l1=512, l2=256):
        ...
        self.fc_out = nn.Linear(l2, 4)  # Adjust the output size to match your label size
        self.relu = nn.ReLU()
